...
document.body.addEventListener('click', (e) => {
  ...
  } else if (e.target.id === 'others-category') {
...
const listBottomSection = document.getElementsByClassName('list-buttom-section');
...
for (let i = 0; i < leftSideSection.length; i++) {
  leftSideSection[i].addEventListener('click', () => {
    ...
    listBottomSection[i].classList.toggle('show-list-buttom-section');
  });
}
